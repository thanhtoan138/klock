            ...
            <Container>
                <Navbar expand="lg" className="bodys">
                    ...
                    <Navbar.Collapse id="navbarScroll">
                        ...
                        <div className="nav-end grid-container col-6 ">
                            <div className='country'>
                                <div className="dropdown">
                                    <div className='lang'>
                                        <img src='/img/uc.png' width={30} height={17} alt='' />
                                        &nbsp;<i className="bi bi-caret-down"></i>
                                    </div>
                                    <div className="dropdown-content">
                                        <p style={{ fontWeight: '600', fontSize: '16px' }}>Select your language</p>
                                        <Row>
                                            <Col md={4} className='col-md-4'>
                                                <div className='flag'>
                                                    <img src='/img/uc.png' width={25} height={20} />
                            ...
                            <div className='login' >
                                <p style={{ marginTop: '6px', marginLeft: '10px', color: 'white' }}>Log in</p>
                            </div>
                        </div>
                    </Navbar.Collapse>
                </Navbar >
            ...
            <Container className='nav2'>
                <Navbar expand="lg">
                    <Container fluid>
                        ...
                        <Navbar.Collapse id="navbarScroll">
                            <Nav
                                className="navscroll me-auto my-2 my-lg-0"
                                style={{ maxHeight: '100px' }}
                                navbarScroll

                            >
                                <Nav.Link className='explore'>
                                    <div className="dropdown">
                                        <div className='title'>
                                        ...
                                        <div className="dropdown-content">
                                            <Row>
                                                <Col lg={4}>
                                                    <div className='side-bar'>
                                                        <div className="container">
                                                            <ListGroup>
                                                                <ListGroup.Item className='item1' style={{ borderRadius: '20px 0px 0px 0px' }}>
                                                                    <div className='hover1'>
                                                                        <p>hover 1</p>
                                                                    </div>
                                                                </ListGroup.Item>
                                                                <ListGroup.Item className='item1'>
                                                                    <div className='hover2' onMouseEnter={() => setHidden2(false)}
                                                ...
                                                <Col lg={8} className='side-bar-show'>
                                                    <div className='show1'>
                                                        <div className='car'>
                                                            <div className='card1'>
                                                                <img src='/img/hcm.jpg' alt='' width={150} height={80} />
                                                                <p className='title'>Hồ Chí Minh City</p>
                                                            </div>
                                                            <div className='card1'>
                                                                <img src='/img/hcm.jpg' alt='' width={150} height={80} />
                                                                <p className='title'>Hồ Chí Minh City</p>
