          ...
          <SwiperSlide>
            ...
            <div className='title'>
              ...
              <div className='search'>
                ...
                <button style={{ backgroundColor: '#ff5b00', borderRadius: '10px', color: 'white', border: 'none', height: '40px', marginTop: '-5px', width: '103px', position: 'absolute', left: '363px' }}>Search</button>
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide>
